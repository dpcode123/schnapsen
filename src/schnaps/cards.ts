...
// Gets all 20 cards
export function getAllCards(): ReadonlyArray<Card> {
    return CARDS;
}

// Gets random card from deck
export function getRandomCardFromDeck(deck: Card[]): Card {
...
export function removeCardFromDeck(card: Card, deck: Card[]): void {
 ...
 */
export function getCardPositionInHandByName(cardName: string, playerHand: Card[]): number {
